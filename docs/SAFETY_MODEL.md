...
Tillian Command Center is built with strict isolation boundaries to ensure safe local execution.
...
- Tillian does not evaluate arbitrary strings or shell inputs.
...
- `tillian.db` and log files are heavily guarded by `.gitignore`.
